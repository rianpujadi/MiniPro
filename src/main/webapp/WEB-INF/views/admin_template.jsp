...
<div class="wrapper">
  ...
  <a href="/dashboard" class="logo">
      ...
      <span class="logo-mini"><img src="${pageContext.request.contextPath }/resources/dist/img/muf.png" class="user-image" alt="User Image"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="${pageContext.request.contextPath }/resources/dist/img/muf.png" class="user-image" alt="User Image"></span>
    </a>
  ...
  <aside class="main-sidebar bg-img">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header text-main">MAIN NAVIGATION</li>
...
<%--          <li><a href="${pageContext.request.contextPath }/admin/master/user"><i class="fa fa-circle-o"></i> User</a></li> --%>
        ...
        <li><a href="${pageContext.request.contextPath }/asset"><i class="fa fa-file-o "></i> Asset</a></li>
...
<!--         <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li> -->
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer bg-img">
    <div class="pull-right hidden-xs">
<!--       <b>Version</b> 2.4.18 -->
    </div>
    <strong class="text-main">Copyright &copy;2019 <a href="https://adminlte.io">Rian Pujadi</a>.</strong> 
  </footer>
